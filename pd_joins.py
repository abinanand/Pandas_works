...
print(f"All movie reviews {data["title"].value_counts()}")
print(f"All movies average rating {data.groupby("title")["rating"].mean()}")
print(f"year wise movies count {movies["year"].value_counts()}")
print(f"language wise movie mount {movies["language"].value_counts()}")
